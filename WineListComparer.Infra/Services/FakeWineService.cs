...
{
    private readonly ILogger<FakeWineService> logger;
    ...
    public FakeWineService(ILogger<FakeWineService> logger)
    {
        this.logger = logger;
    }
    ...
    {
        logger.LogTrace("Running fake wineservice.");
        logger.LogInformation("Running fake info wineservice.");
        Task.Delay(3000);
        Thread.Sleep(3000);
